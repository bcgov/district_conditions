...
shiny::selectInput("which_district", 
            ...
            choices = unique(district_conditions$District), 
            selected = unique(district_conditions$District)[1]) 
```
...
```{r}
  ...
  #standardized<- plotly::highlight_key(standardized, ~District) 
  ...
  gg  
#  plotly::highlight(gg, on = "plotly_hover", off = "plotly_deselect", color = "red")
})%>%
